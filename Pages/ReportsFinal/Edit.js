...
function createTableEdit(){
    ...
    for(var k in dictionaryOfDatesToBeAdded){
        ...
        for(var l in individualEventArray){
            ...
            var tdEventJob = $('<td>' + individualEventArray[l].jobName + '</td>');
            var tdTime = $('<td>' + individualEventArray[l].time + '</td>');
            var tdEventAddress = $('<td>' + individualEventArray[l].jobAddress + '</td>');
